            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center">
                        <div>
                            <h1 class="text-3xl font-bold mb-2">Job Opportunities</h1>
                            <p class="text-gray-600">Browse available job postings from employers</p>
                        </div>
                        @auth
                            @if(auth()->user()->isAdmin())
                                <a href="{{ route('admin.jobs.index') }}" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-lg shadow-md">
                                    🛠️ Admin Panel
                                </a>
                            @endif
                        @endauth
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow">
                            <div class="p-6">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    @else
                                        <a href="{{ route('login') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm">
                                            Login to Apply
                                        </a>
                                    @endauth
                                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-12 text-center">
                        ...
                        @auth
                            @if(auth()->user()->isAdmin())
                                <div class="mt-4">
                                    <a href="{{ route('admin.jobs.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-block">
                                        Post Your First Job
                                    </a>
                                </div>
                            @endif
